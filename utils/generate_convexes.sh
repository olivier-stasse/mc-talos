...
generate_convexes "$HOME/Softwares/catkin_ws/src/talos_robot/talos_description/meshes" ""
generate_convexes "$HOME/Softwares/to_deploy_mc_rtc/mc-talos/meshes" "mirrored"
